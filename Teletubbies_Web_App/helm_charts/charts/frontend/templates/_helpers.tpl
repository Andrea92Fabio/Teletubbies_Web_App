...
{{/*
Fullname per il subchart Frontend
*/}}
{{- define "frontend.fullname" -}}
{{- printf "%s-frontend" (include "teletubbies-web-app.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}

{{/*
Fullname per il subchart Backend (richiamato dall'Ingress)
Nota: Presuppone che il Chart radice definisca una funzione 'backend.fullname'.
*/}}
